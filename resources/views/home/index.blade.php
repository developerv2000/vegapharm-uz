...
<section class="greeting home-greeting">
  <video class="video greeting-video" autoplay muted loop>
    <source src="{{ asset('img/home/vega.mp4') }}" type="video/mp4">
  ...
  <div class="greeting__inner main-container">
    ...
    <div class="only-mobile mobile-greeting">
      ...
      <div class="mobile-greeting__image-container">
        <img class="mobile-greeting__image" src="{{ asset('img/main/doctor.png') }}" alt="doctor">
      </div>
    </div>
  </div>
</section>
